...
def get_datasets_folder():
    ...
    datasets_folder = os.path.abspath(os.path.join(here, '../data/datasets'))
    datasets_archive = os.path.abspath(os.path.join(here, '../data/datasets.zip'))
